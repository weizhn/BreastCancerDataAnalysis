...
A3787T3 <- filtob(A3787T3,100,7500,200,40000,30,15,15)
A3788T2 <- filtob(A3788T2,100,7500,200,40000,30,15,15)
A3789T2 <- filtob(A3789T2,100,7500,200,40000,30,15,15)
A3790T3 <- filtob(A3790T3,100,7500,200,40000,30,15,15)
A3791T3 <- filtob(A3791T3,100,7500,200,40000,30,15,15)
A3792T3 <- filtob(A3792T3,100,7500,200,40000,30,15,15)
A3793T4 <- filtob(A3793T4,100,7500,200,40000,30,15,15)
A3794T4 <- filtob(A3794T4,100,7500,200,40000,30,15,15)
A4108T2 <- filtob(A4108T2,100,7500,200,40000,30,15,15)
A4109T4 <- filtob(A4109T4,100,7500,200,40000,30,15,15)
